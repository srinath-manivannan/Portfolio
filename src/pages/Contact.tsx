      ...
      <div className="container mx-auto max-w-5xl relative">
        ...
        >
          ...
          <div className="mt-6 flex flex-wrap gap-3 justify-center">
            ...
            <span className="px-3 py-1 rounded-full bg-[hsl(var(--card))]/70 text-foreground/80 text-sm border border-[hsl(var(--border))]">
              Timezone: IST
            </span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          >
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <Button type="submit" className="flex-1 gradient-primary text-white sheen glow-soft" disabled={isSubmitting}>
                  {isSubmitting ? (
                    <>Sending...</>
                  ) : (
                    <>
                ...
                <a href="mailto:srinathmpro2001@gmail.com" className="flex-1">
                  <Button type="button" variant="outline" className="w-full animated-border">
                    Or Email Me
                  </Button>
                </a>
              </div>
          ...
          >
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              {/* Email */}
              <a href="mailto:srinathmpro2001@gmail.com" className="group">
                <div className="glassmorphic rounded-2xl p-6 hover-lift sheen glow-soft">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="text-muted-foreground group-hover:text-primary transition-colors truncate overflow-hidden text-ellipsis break-all sm:break-normal max-w-[16rem]">
              ...
              {/* Phone */}
              <a href="tel:8144429317" className="group">
                <div className="glassmorphic rounded-2xl p-6 hover-lift sheen glow-soft">
                  <div className="flex items-center gap-4">
                    <div className="w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center flex-shrink-0">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="text-muted-foreground group-hover:text-primary transition-colors truncate overflow-hidden text-ellipsis max-w-[16rem]">
                        +91 8144429317
                      </p>
                    </div>
                  </div>
              ...
              <div className="glassmorphic rounded-2xl p-6 hover-lift sheen glow-soft">
                <div className="flex items-center gap-4">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-muted-foreground truncate overflow-hidden text-ellipsis max-w-[16rem]">Tindivanam, Tamil Nadu, India</p>
                  </div>
                </div>
              </div>
              ...
              <div className="glassmorphic rounded-2xl p-6 hover-lift sheen glow-soft">
                <div className="flex items-center gap-4">
                  ...
                  <div className="min-w-0">
                    <p className="font-medium leading-tight">Availability</p>
                    <p className="text-green-500 truncate overflow-hidden text-ellipsis max-w-[16rem]">Open for opportunities</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 gap-6">
              <div className="glassmorphic rounded-2xl p-6">
                <div className="grid sm:grid-cols-2 gap-6">
                  {/* WhatsApp */}
                  <a href="https://wa.me/918144429317" target="_blank" rel="noopener noreferrer" className="group">
                    <div className="rounded-2xl p-6 hover-lift glow-soft"
                      style={{ background: 'linear-gradient(135deg, rgba(16,185,129,0.12), rgba(16,185,129,0.06))' }}
                    >
                      ...
                      <p className="text-green-500 group-hover:underline">+91 8144429317</p>
                    </div>
                  </a>

                  {/* LinkedIn */}
                  <a
                    href="https://www.linkedin.com/in/srinath-manivannan-57a751197/"
                    target="_blank"
                  ...
                  >
                    ...
                    >
                      ...
                      <p className="text-blue-500 group-hover:underline">Connect with me</p>
                    </div>
                  </a>
                </div>
              </div>
