            ...
            return (
              ...
              >
                ...
                {(index === 0 || experiences[index - 1]?.duration?.split('–')[0]?.trim() !== exp.duration?.split('–')[0]?.trim()) && (
                  <div className="absolute -left-[7.5rem] top-5 text-xs font-mono text-muted-foreground/40 w-16 text-right">
                    ...
                    {isExpanded && (
                      ...
                      >
                        <div className="mt-4 pt-4 border-t border-white/[0.04]">
                            ...
                            <ul className="space-y-2.5 mb-4">
                              {exp.description.map((item: string, i: number) => (
                                <motion.li
                                  ...
                                  animate={{ opacity: 1, x: 0 }}
                                  transition={{ delay: i * 0.05 }}
                                  className="flex gap-2.5 items-start text-muted-foreground/50 text-sm"
                                >
                          ...
                          {Array.isArray(exp.technologies) && exp.technologies.length > 0 && (
                            <div>
                              <p className="text-[10px] font-semibold text-muted-foreground/50 uppercase tracking-wider mb-2">Technologies</p>
